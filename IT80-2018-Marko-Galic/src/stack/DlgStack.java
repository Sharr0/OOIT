...
public class DlgStack extends JDialog {
	...
	public DlgStack() {
		...
		{
			JLabel lblNewLabel_11 = new JLabel("Radius");
			GridBagConstraints gbc_lblNewLabel_2 = new GridBagConstraints();
			gbc_lblNewLabel_2.insets = new Insets(0, 0, 5, 5);
			gbc_lblNewLabel_2.gridx = 1;
			gbc_lblNewLabel_2.gridy = 5;
			contentPanel.add(lblNewLabel_11, gbc_lblNewLabel_2);
		}
		{
	...
	public final JTextField getTxtRadius() {
		return txtRadius;
	}

	public final void setTxtRadius(JTextField txtRadius) {
